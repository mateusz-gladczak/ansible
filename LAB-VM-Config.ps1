...
Write-host "Adding local ansible user"
$password = ConvertTo-SecureString "P@ssw0rd" -AsPlainText -Force
New-LocalUser -Name "ansible" -Password $password -FullName "Ansible user" -Description "Ansible user"
Add-LocalGroupMember -Group "Administrators" -Member "\ansible"


Write-Host "disabling CAD"
$registrypathcad = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System"
$CADname = "DisableCAD"
$cadValue = "1"
Set-ItemProperty -Path $registrypathcad -Name $CADname -Value $cadValue | out-null

Write-host "Disabling server manager"
$registrypathsm = "HKLM:\Software\Microsoft\ServerManager"
$sm1key = "DoNotOpenServerManagerAtlogon"
$sm2key = "CheckedUnattendLaunchSetting"
$sm1value = "1"
$sm2value = "0"
Set-ItemProperty -Path $registrypathsm -Name $sm1key -Value $sm1value | out-null
Set-ItemProperty -Path $registrypathsm -Name $sm2key -Value $sm2value | out-null
